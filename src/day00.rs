...
impl Solver for Day00 {
  fn part_one(&self) -> anyhow::Result<String> { Err(anyhow::anyhow! {"Not Implemented yet"}) }

  fn part_two(&self) -> anyhow::Result<String> { Err(anyhow::anyhow! {"Not Implemented yet"}) }
}
